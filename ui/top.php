...
<style>
#home.home-particles {
	/*background-image: url('<?php bgMod('login'); ?>');*/
...
color: rgba(17, 17, 17, 0.7);
      ...
      <div class="row" >
        <div class="container" align="center" style="background:rgba(0, 0, 0, 0.74);padding:20px;">
          <center>
            <h1 style="font-size:35px;">Aurganon'17 Comming Soon</h1>
            <script>
            ...
            <div class="main-content-tablecell" style="padding-top: 10px;">
              ...
              <h1 style="font-size:20px;">Department Of Information Technology Presents</h1>
              <script>
...
?>  
              	 <a onClick='openInNewTab("https://www.facebook.com/search/top/?q=%23powerup&ref=eyJzaWQiOiIwLjkwMzI5NTEyNjIyMDc0NzYiLCJxcyI6IkpUVkNKVEl5SlRJemNHOTNaWEoxY0NVeU1pVTFSQSIsImd2IjoiYmVlMDlmOTNmYTczMmNmYTU5YTFjYjZkOWY0NTBkMzg5MjQyNGU0OSJ9")'><font color="orange">#powerUP</font></a> </p>
...
$(document).ready(function(){
	...
	var backgrounds = new Array(
		...
		, 'url(images/bat.jpg)'
		, 'url(images/deadp.jpg)'
		, 'url(images/spidy.jpg)'
	);
